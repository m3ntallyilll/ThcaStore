...
export default function Checkout() {
  ...
  const shippingCost = subtotal >= 100 ? 0 : 8.99; // Free shipping over $100, otherwise $8.99
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card className="bg-white/10 border-white/20 backdrop-blur-md">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="border-t border-white/20 pt-4">
                ...
                <div className="flex justify-between items-center mb-2">
                  <span className="text-white/80">Shipping (Basic):</span>
          ...
          <Card className="bg-white/10 border-white/20 backdrop-blur-md">
            ...
            <CardContent className="space-y-6">
              ...
              <div className={`${shippingCost === 0 ? 'bg-green-500/10 border-green-500/20' : 'bg-blue-500/10 border-blue-500/20'} rounded-lg p-4`}>
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2">
                    <Truck className={`w-5 h-5 ${shippingCost === 0 ? 'text-green-400' : 'text-blue-400'}`} />
                    <span className={`font-semibold ${shippingCost === 0 ? 'text-green-400' : 'text-blue-400'}`}>
                      Basic Shipping
                    </span>
                  </div>
                  <span className={`text-xl font-bold ${shippingCost === 0 ? 'text-green-400' : 'text-blue-400'}`}>
                    {shippingCost === 0 ? "FREE!" : "$8.99"}
                  </span>
                </div>
                <p className="text-white/80 text-sm">
                  {shippingCost === 0 
                    ? "🎉 Free discreet USPS envelope shipping on orders $100+"
                    : "Discreet USPS envelope shipping. Free on orders over $100!"}
                </p>
              </div>
