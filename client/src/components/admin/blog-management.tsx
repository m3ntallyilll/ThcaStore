  ...
  useEffect(() => {
    if (blogFormData) {
      setFormData({
        ...
        tags: Array.isArray(blogFormData.tags) ? blogFormData.tags : (blogFormData.tags ? blogFormData.tags.split(', ') : []),
        metaTitle: blogFormData.metaTitle || '',
        metaDescription: blogFormData.metaDescription || '',
        keywords: Array.isArray(blogFormData.keywords) ? blogFormData.keywords : (blogFormData.keywords ? blogFormData.keywords.split(', ') : []),
